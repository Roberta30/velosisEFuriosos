class Game {
  constructor() {
    ...
    this.FoiDeArrastaPraBaixo = false;
  }
  ...
  start() {
    ...
    car1.scale = 0.07;
    car1.addImage("kaboom", kaboomImg);

    car2 = createSprite(width / 2 + 100, height - 100);
    car2.addImage("car2", car2_img);
    car2.scale = 0.07;
    car2.addImage("kaboom", kaboomImg);
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        var FoiDeArrastaPraCima = allPlayers[plr].life

        if(FoiDeArrastaPraCima <= 0){
        ...
        if (index === player.index) {
          ...
          if(FoiDeArrastaPraCima <= 0){
            this.FoiDeArrastaPraBaixo = true;
            this.playerMoving = false;
          }
